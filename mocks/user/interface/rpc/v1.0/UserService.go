...
func (_m *UserService) DeleteUser(ctx context.Context, in *protocol.DeleteUserRequestType) (*protocol.EmptyResponseType, error) {
...
func (_m *UserService) UpdateUser(ctx context.Context, in *protocol.UpdateUserRequestType) (*protocol.EmptyResponseType, error) {
	ret := _m.Called(ctx, in)
