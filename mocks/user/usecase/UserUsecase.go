...
import (
	usecase "github.com/stereoit/eventival/pkg/user/usecase"
...
// ListAllUsers provides a mock function with given fields: page, limit
func (_m *UserUsecase) ListAllUsers(page int, limit int) ([]*usecase.User, error) {
	ret := _m.Called(page, limit)

	var r0 []*usecase.User
	if rf, ok := ret.Get(0).(func(int, int) []*usecase.User); ok {
		r0 = rf(page, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*usecase.User)
